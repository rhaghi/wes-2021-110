...
poly_load_thrust = cp.load('BEM_Thrust_SM_PolyOrder_4.npz',allow_pickle=True)
poly_load_torque = cp.load('BEM_Torque_SM_PolyOrder_4.npz',allow_pickle=True)
...
f=open(tstr_file+'_CPU_Time_P4_MC_trt.pckl','wb')
pickle.dump(cpu_time_trt,f)
f.close()

f=open(tstr_file+'_CPU_Time_P4_MC_trq.pckl','wb')
